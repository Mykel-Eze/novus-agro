...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"author","content":"Novus Agro"},{"hid":"description","name":"description","content":"Novus Agro is a platform that connects rural farmers with urban markets, enabling them to sell their produce directly."},{"name":"Keywords","content":"Novus Agro, rural farmers, urban markets, agriculture, produce, platform"},{"name":"theme-color","content":"#056839"}],"link":[{"rel":"icon","type":"image/png","href":"/novus-agro-icon.png"}],"style":[],"script":[],"noscript":[],"title":"Novus Agro - Taking Markets To Rural Communities"};
